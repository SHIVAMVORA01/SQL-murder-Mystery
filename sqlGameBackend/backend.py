...
con = sql.connect(
    r'C:\Users\voras\Desktop\SQL-murder-Mystery\sqlGameBackend\sql-murder-mystery.db', check_same_thread=False)
queries = [
    '''
SELECT *
    ...
    def post(self):
        try:
            ...
            if os.path.isfile(r'C:\Users\voras\Desktop\SQL-murder-Mystery\sqlgame\src\output.png'):
                os.remove(
                    r'C:\Users\voras\Desktop\SQL-murder-Mystery\sqlgame\src\output.png')
            dfi.export(queryResult, 'C:/Users/voras/Desktop/SQL-murder-Mystery/sqlgame/src/output.png',
